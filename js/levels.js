    ...
    levels: [
      {
        ...
        maxCommands: null,
        hint: 'Add 5 "Move Forward" blocks!',
      },
      {
        id: 'mv-2',
        groupId: 'movement',
        ...
        maxCommands: null,
        hint: 'Move north 4 times, then turn right and move east 5 times.',
      },
      {
        id: 'mv-3',
        groupId: 'movement',
      ...
      },
      {
        ...
        availableCommands: ['move-forward', 'move-back', 'turn-left', 'turn-right'],
        winCondition: { type: 'reach', target: { col: 0, row: 2 } },
        maxCommands: 2,
        hint: 'There\'s a defender ahead! The try line is behind Finn — use Move Back twice.',
      },
    ],
  },

  {
    ...
    levels: [
      ...
      },
      {
        ...
        finn: { startCol: 0, startRow: 2, startDir: 'east' },
        availableCommands: ['move-forward', 'turn-left', 'turn-right', 'if-condition'],
        // Solution: F→(1,2), if mud@(2,2)→TL,F→(1,1),TR facing east, F×5→(6,1)=try
        winCondition: { type: 'reach', target: { col: 6, row: 1 } },
        maxCommands: null,
      ...
      },
      {
        ...
        maxCommands: null,
        hint: 'Use IF to dodge each defender — you\'ll need two IF blocks this time!',
      },
      {
        id: 'cond-6',
        groupId: 'conditions',
        ...
        maxCommands: null,
        hint: 'Move forward to grab the ball, then use IF to dodge the defender!',
      },
    ],
  },
    ...
    levels: [
      {
        ...
        winCondition: { type: 'reach', target: { col: 8, row: 2 } },
        maxCommands: null,
        hint: 'Use REPEAT 7 times with Move Forward inside!',
      },
      {
        id: 'loop-2',
        groupId: 'loops',
        ...
        availableCommands: ['move-forward', 'turn-left', 'turn-right', 'repeat'],
        // Solution: repeat(6)[F](→6,3), TR(south), repeat(3)[F](→6,6) = try
        winCondition: { type: 'reach', target: { col: 6, row: 6 } },
        maxCommands: null,
        hint: 'Use REPEAT 6 to go east, then Turn Right, then REPEAT 3 to go south!',
      },
      {
        id: 'loop-3',
        groupId: 'loops',
      ...
      },
      {
        ...
        winCondition: {
          type: 'reach-any',
          targets: [{ col: 10, row: 3 }, { col: 10, row: 2 }],
        },
        maxCommands: null,
      ...
      },
      {
        ...
        maxCommands: null,
        hint: 'Each cone is 2 squares apart — put two Move Forwards inside REPEAT 4!',
      },
      {
        id: 'loop-6',
        groupId: 'loops',
        ...
        maxCommands: null,
        hint: 'REPEAT 6 to go east, Turn Left to face north, then REPEAT 6 to reach the corner!',
      },
    ],
  },
    ...
    levels: [
      {
        ...
        description: "Sprint is faster than Move Forward — it covers 2 squares at once. Use it to blast to the try line!",
        grid: { cols: 9, rows: 5 },
        cells: [
          { col: 8, row: 2, type: 'try-line' },
        ],
        finn: { startCol: 0, startRow: 2, startDir: 'east' },
        availableCommands: ['sprint', 'move-forward', 'turn-left', 'turn-right'],
        winCondition: { type: 'reach', target: { col: 8, row: 2 } },
        maxCommands: 5,
        hint: 'Sprint covers 2 squares at once — just 4 Sprints will reach the try line!',
      },
      {
        id: 'adv-2',
        groupId: 'advanced',
        ...
        availableCommands: ['move-forward', 'move-back', 'turn-around', 'sprint', 'turn-left', 'turn-right'],
        winCondition: { type: 'reach', target: { col: 0, row: 2 } },
        maxCommands: 4,
        hint: 'Turn Around faces Finn west, then 3 Sprints carry him to the try line!',
      },
      {
        id: 'adv-3',
        groupId: 'advanced',
        ...
        availableCommands: ['move-forward', 'sprint', 'while-clear'],
        winCondition: { type: 'reach', target: { col: 10, row: 1 } },
        maxCommands: 2,
        hint: 'Two blocks only! Put Move Forward inside While Clear — Finn runs until the try line!',
      },
      {
        id: 'adv-4',
        groupId: 'advanced',
        title: 'Grand Slam',
        description: "Dodge a defender, pick up the ball, run the corridor, and score — you have every tool you need!",
        grid: { cols: 11, rows: 7 },
        cells: [
        ...
        availableCommands: ['move-forward', 'turn-left', 'turn-right', 'sprint', 'turn-around', 'if-condition', 'repeat', 'while-clear'],
        winCondition: {
          type: 'visit-waypoints-then-reach',
        ...
        maxCommands: null,
        hint: 'Dodge the first defender, run north to grab the ball, use While Clear to sprint east, then find a path to the try line!',
      },
      {
        id: 'adv-5',
        groupId: 'advanced',
        title: 'Wall of Defenders',
        description: "A line of defenders blocks the centre of the pitch. Find the gap and sprint through!",
        grid: { cols: 11, rows: 5 },
        cells: [
          { col: 5, row: 2, type: 'obstacle' },
        ...
        finn: { startCol: 0, startRow: 2, startDir: 'east' },
        availableCommands: ['move-forward', 'sprint', 'turn-left', 'turn-right', 'if-condition', 'while-clear'],
        winCondition: { type: 'reach-any', targets: [{ col: 10, row: 0 }, { col: 10, row: 1 }] },
        maxCommands: null,
        hint: 'Move north to find the gap in the defensive line, then use Sprint or While Clear to blast east to the try line!',
      },
      {
        id: 'adv-6',
        groupId: 'advanced',
        title: 'World Cup Final',
        description: "The ultimate challenge — grab the ball, dodge two defenders, and score the winning try for Scotland!",
        grid: { cols: 11, rows: 5 },
        cells: [
        ...
        maxCommands: null,
        hint: 'Grab the ball first, then dodge two defenders by turning north each time, and sprint to the top corner!',
      },
    ],
  },
];
