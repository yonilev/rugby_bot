...
const GROUPS = [
  {
    ...
    levels: [
      ...
      },
      {
        ...
        groupId: 'movement',
        title: 'Step Back!',
        description: "A defender is blocking Finn's path — but the try line is right behind him!",
        grid: { cols: 7, rows: 5 },
        cells: [
          { col: 4, row: 1, type: 'obstacle' },
          { col: 4, row: 3, type: 'try-line' },
          { col: 4, row: 4, type: 'try-line' },
        ],
        finn: { startCol: 4, startRow: 2, startDir: 'north' },
        availableCommands: ['move-forward', 'move-back', 'turn-left', 'turn-right'],
        winCondition: { type: 'reach-any', targets: [{ col: 4, row: 3 }, { col: 4, row: 4 }] },
        maxCommands: 2,
    ...
    levels: [
      {
        ...
        winCondition: { type: 'reach', target: { col: 7, row: 2 } },
        maxCommands: 5,
        hint: 'Sprint covers 2 squares at once — just 3 Sprints will reach the try line!',
      },
      {
        id: 'adv-2',
        groupId: 'advanced',
        ...
        grid: { cols: 9, rows: 5 },
        cells: [
          { col: 8, row: 2, type: 'obstacle' },
          { col: 1, row: 2, type: 'try-line' },
        ],
        finn: { startCol: 7, startRow: 2, startDir: 'east' },
        availableCommands: ['move-forward', 'move-back', 'turn-around', 'sprint', 'turn-left', 'turn-right'],
        winCondition: { type: 'reach', target: { col: 1, row: 2 } },
        maxCommands: 4,
