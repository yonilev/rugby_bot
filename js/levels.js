    ...
    levels: [
      {
        ...
        winCondition: { type: 'reach', target: { col: 8, row: 2 } },
        maxCommands: 5,
        hint: 'Opponents flank the pitch — stay on row 2 and sprint east! 4 Sprints reach the try line.',
      },
      {
        id: 'adv-2',
        groupId: 'advanced',
      ...
      },
      {
        ...
        maxCommands: null,
        hint: 'Dodge the first defender and the lurking opponents, run north to grab the ball, use While Clear to sprint east, then find a path to the try line!',
      },
      {
        id: 'adv-5',
        groupId: 'advanced',
        title: 'Wall of Defenders',
        description: "A line of defenders blocks the centre of the pitch. An opponent patrols the far end — find the only safe path!",
        grid: { cols: 11, rows: 5 },
        cells: [
          { col: 5, row: 2, type: 'obstacle' },
        ...
        maxCommands: null,
        hint: 'Find the gap in the defensive wall, but watch out — an opponent guards row 1 in the far half! Use row 0 to reach the try line.',
      },
      {
        id: 'adv-6',
        groupId: 'advanced',
        title: 'World Cup Final',
        description: "The ultimate challenge — grab the ball, dodge defenders and opponents, and score the winning try for Scotland!",
        grid: { cols: 11, rows: 5 },
        cells: [
